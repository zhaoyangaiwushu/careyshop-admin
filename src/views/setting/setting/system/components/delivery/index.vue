<template>
  <el-form
    ...
    :model="form"
    label-width="200px">
    <div v-permission="'/setting/setting/system/delivery/money'">
    ...
    <div v-permission="'/setting/setting/system/delivery/amount'">
    ...
    <div v-permission="'/setting/setting/system/delivery/lower'">
