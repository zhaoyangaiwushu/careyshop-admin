<template>
  <el-form
    ...
    :model="form"
    label-width="200px">
    <div v-permission="'/setting/setting/system/upload/basis'">
    ...
    <div v-permission="'/setting/setting/system/upload/careyshop'">
    ...
    <div v-permission="'/setting/setting/system/upload/qiniu'">
    ...
    <div v-permission="'/setting/setting/system/upload/aliyun'">
